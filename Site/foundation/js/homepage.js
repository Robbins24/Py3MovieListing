...
Demo.prototype.addShuffleEventListeners = function () {
  var handler = function (event) {
    ...
    document.getElementById("myspan").textContent=event.detail.shuffle.visibleItems;
  };
...
Demo.prototype._handleFilterClick = function (evt) {
  ...
  // 'exclusive' mode lets only one filter button be active at a time.
    ...
    if (isActive) {
      ...
      document.getElementById("categoryspan").textContent="All Titles";
    } else {
      btn.classList.add('active');
      filterGroup = btnGroup;
      document.getElementById("categoryspan").textContent=btnGroup.replace(/\b\w/g, function(l){ return l.toUpperCase() });
    }
...
Demo.prototype.addSorting = function () {
  var menu = document.querySelector('#sorting');
...
Demo.prototype._handleSearchKeyup = function (evt) {
  ...
  this.shuffle.filter(function (element, shuffle) {
    ...
    var titleElement = element.querySelector('.titletext'); 
