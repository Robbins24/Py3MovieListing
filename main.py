	...
	try:
		...
		try:
			...
			for movie_object in movie_objects_list:	 
				...
				html_file.write('<div class="panel">')
				html_file.write('<a href="file://' + source_dir + '\test" class="button large success expand">' + movie_object.title + ' (' + movie_object.year + ')' + '</a>')
			...
			for number in range(len(failed_movie_objects_list)):
				html_file.write('<a href="#" class="button large success expand">' + str(failed_movie_objects_list[number]) + '</a><br/> ')
